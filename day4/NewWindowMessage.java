  ...
  public void f() {
	  ...
	  for(String w:windows) {
		  if(w.equals(window1)) {
			  ...
			  d.switchTo().window(w);
			  System.out.println(d.findElement(By.linkText("Knowledge increases by sharing but not by saving. Please share this website with your friends and in your organization.Knowledge increases by sharing but not by saving. Please share this website with your friends and in your organization.Knowledge increases by sharing but not by saving. Please share this website with your friends and in your organization.")).getText());
		  }
	  }
  }
  @BeforeMethod
